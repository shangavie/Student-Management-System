...
<html lang="en">
  ...
  <input type="reset" class="btn btn-warning" value="Reset">
    ...
    <div class = "row">
           ...
           <div class="card mb-3">
  <img class="card-img-top" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSr8Y8UN_8mb_tOr6Dy3LZ1YPtRmelrvS8FYA&usqp=CAU" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">Enter the informations of new students</h5>
    @csrf
  <div class="form-group">
    <label>CNE</label>
    <input name="cne" type="text" class="form-control"  placeholder="Enter cne">
